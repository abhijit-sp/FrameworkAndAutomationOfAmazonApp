...
/*
A concrete implementation of the ResultsPage in portrait mode.
 */
public class ResultsPagePortrait extends ResultsPage {

    public ResultsPagePortrait(AndroidDriver<MobileElement> driver) {
        super(driver);
    }
