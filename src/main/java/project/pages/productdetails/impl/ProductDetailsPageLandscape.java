...
/*
A concrete implementation of the ProductDetailsPage in landscape mode.
 */
public class ProductDetailsPageLandscape extends ProductDetailsPage {

    public ProductDetailsPageLandscape(AndroidDriver<MobileElement> driver) {
        super(driver);
    }
